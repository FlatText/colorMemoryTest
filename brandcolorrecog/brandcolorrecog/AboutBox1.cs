...
namespace brandcolorrecog
{
    partial class AboutBox : Form
    {
        public AboutBox()
        {
            InitializeComponent();
            string version = "0.1";
            string company = "Szilárd Váthy, Computer Scientist Bsc";
            string desc = "In the software, the participant should recognise the original colors of a brand, while " +
            ...
            this.labelProductName.Text = "Creating a software to test color memory";
